...
export const capabilities: Capability[] = [
  {
    ...
    subtitle: "让市场输入先变得可信。",
    summary:
      "数据不是仓库里的原料，而是研究系统的第一层判断。WinQ 关注数据采集、清洗、对齐与质量审查，让每一次实验都有可追溯的输入基础。",
    statement:
  ...
  },
  {
    ...
    summary:
      "研究不是结论的陈列，而是问题、假设、实验与审查的连续过程。WinQ 用结构化路径验证信号是否可靠，避免被单次结果说服。",
    statement:
  ...
  },
  {
    ...
    summary:
      "持续迭代把数据、研究、执行与复盘连成闭环。WinQ 关注的是长期可演进的系统，而不是一次性的策略产出。",
    statement:
