# WinQ Lab Website Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Build the first public `WinQ Lab` website as a polished Chinese-language quant research lab brand site, optimized for static deployment on `GitHub Pages`.
...
describe("site metadata", () => {
  it("uses the approved WinQ Lab brand and route structure", () => {
    expect(siteMeta.name).toBe("WinQ Lab");
...
export const siteMeta = {
  ...
  description:
    "WinQ Lab 专注于量化策略研究、交易系统构建与研究基础设施设计。",
